...
const Graph = () => {
  return (
    <div className='lg:col-span-2'>
      <Headings headingText='Weekly Activity' headingTextPosition='text-start' headingTextSize='text-[22px]'/>
    <div className=" bg-white rounded-2xl pt-6  lg:p-6 shadow-sm w-full h-[300px]">
